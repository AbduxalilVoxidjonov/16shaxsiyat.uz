 ...
 *
 * Manba filtri YO'Q (2026-09-07): ro'yxat faqat maktab sessiyalarini ko'rsatadi, ommaviy
 * makon sessiyalari o'z bo'limida (`/admin/ommaviy`) — `features/students` bilan bir xil.
 */
