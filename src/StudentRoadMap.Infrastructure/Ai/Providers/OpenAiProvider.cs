...
public sealed class OpenAiProvider : IAiAnalysisProvider
{
    ...
    public OpenAiProvider(IHttpClientFactory httpClientFactory, string apiKey, string model, string? baseUrl = null, Func<TimeSpan, CancellationToken, Task>? delay = null)
    {
