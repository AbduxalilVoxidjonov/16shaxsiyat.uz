...
namespace StudentRoadMap.Infrastructure.Migrations
{
    ...
    [Migration("20260911234638_AddStudentProfileExtra")]
    partial class AddStudentProfileExtra
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.Assessments.Answer", b =>
                {
                    ...
                    b.ToTable("answers", null, t =>
                        {
                            t.HasCheckConstraint("ck_answers_shape", "(raw_value IS NOT NULL)::int\n+ (text_value IS NOT NULL)::int\n+ (selected_values IS NOT NULL)::int = 1");
                        });
                });
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.Assessments.Assessment", b =>
                {
                    ...
                    b.HasIndex("SessionTokenHash")
                        .IsUnique()
                        .HasDatabaseName("ux_assessments_token_hash");
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.Catalog.QuestionSection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_question_sections");

                    b.HasIndex("TestDefinitionId", "Code")
                        .IsUnique()
                        .HasDatabaseName("ux_question_sections_test_code");

                    b.HasIndex("TestDefinitionId", "DisplayOrder")
                        .HasDatabaseName("ix_question_sections_test_order");

                    b.ToTable("question_sections", (string)null);
                });
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.Identity.AdminUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("PendingTotpCreatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("pending_totp_created_at");

                    b.Property<string>("PendingTotpSecretEncrypted")
                        .HasColumnType("text")
                        .HasColumnName("pending_totp_secret_encrypted");
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.PublicUsers.PublicRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_public_refresh_tokens");

                    b.HasIndex("PublicUserId")
                        .HasDatabaseName("ix_public_refresh_tokens_user");

                    b.HasIndex("TokenHash")
                        .IsUnique()
                        .HasDatabaseName("ux_public_refresh_tokens_hash");

                    b.ToTable("public_refresh_tokens", (string)null);
                });

            modelBuilder.Entity("StudentRoadMap.Domain.PublicUsers.PublicUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DeletionComment")
                        ...
                        .HasColumnName("deletion_comment");

                    b.Property<short?>("DeletionReason")
                        .HasColumnType("smallint")
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.Schools.School", b =>
                {
                    ...
                    b.Property<bool>("ShowResultToStudent")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("show_result_to_student");
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.Settings.RegistrationFormSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_registration_form_settings");

                    b.ToTable("registration_form_settings", (string)null);
                });
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.Students.Student", b =>
                {
                    ...
                    b.Property<bool>("ParentalConsent")
                        ...
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("parental_consent");
                    ...
                    b.Property<string>("ProfileExtra")
                        .HasColumnType("jsonb")
                        .HasColumnName("profile_extra");
                    ...
                    b.ToTable("students", null, t =>
                        {
                            t.HasCheckConstraint("ck_students_grade", "grade BETWEEN 0 AND 11");
                        });
                });
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.Catalog.Question", b =>
                {
                    b.HasOne("StudentRoadMap.Domain.Catalog.QuestionSection", null)
                        .WithMany()
                        .HasForeignKey("SectionId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_questions_question_sections_section_id");
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.Catalog.QuestionSection", b =>
                {
                    b.HasOne("StudentRoadMap.Domain.Catalog.TestDefinition", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_question_sections_test_definitions_test_definition_id");
                });
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.PublicUsers.PublicRefreshToken", b =>
                {
                    b.HasOne("StudentRoadMap.Domain.PublicUsers.PublicUser", null)
                        .WithMany()
                        .HasForeignKey("PublicUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_public_refresh_tokens_public_users_public_user_id");
                });
            ...
            modelBuilder.Entity("StudentRoadMap.Domain.Students.Student", b =>
                {
                    b.HasOne("StudentRoadMap.Domain.PublicUsers.PublicUser", null)
                        ...
                        .HasForeignKey("PublicUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_students_public_users_public_user_id");
