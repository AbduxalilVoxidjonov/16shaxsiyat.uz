...
/// sessiya va shkala SIGNALLARI esa filtrga qaramay BUTUN sessiya bo'yicha qaytadi
/// (<see cref="AdminAssessmentAnswersDto"/> izohiga qarang).
/// </summary>
public sealed record GetAssessmentAnswersQuery(Guid Id, string? TestCode) : IRequest<Result<AdminAssessmentAnswersDto>>;
